...
Write only the dated `*-audit.md` in the exact registered `docs-ai/<work-key>-<slug>/` folder with:
...
Read explicit historical artifact layouts when necessary but do not migrate or modify them.
