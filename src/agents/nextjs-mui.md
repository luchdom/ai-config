...
- Exercise affected routes, states, themes, and representative mobile/desktop viewports in a real browser during development. Return that exact matrix and implementation identity for the required product-designer design conformance review.
