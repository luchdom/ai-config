...
- Use the smallest applicable stages. Routine work may plan and task inline; add independent audit, runtime QA, or durable evidence when risk or acceptance criteria justify them. Frontend/UI work must follow `goal-to-delivery/references/design-gates.md`: initialize or resume a registered `artifactFolder`, route unresolved UI decisions to product-designer before implementation, and require product-designer conformance afterward.
